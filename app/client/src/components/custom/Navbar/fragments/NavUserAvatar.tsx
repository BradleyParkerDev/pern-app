...
const NavUserAvatar = React.forwardRef<
...
const NavUserAvatarImage = React.forwardRef<
...
const NavUserAvatarFallback = React.forwardRef<
...
>(({ className, ...props }, ref) => (
	<AvatarPrimitive.Fallback
		ref={ref}
		className={cn(
			'bg-muted text-foreground flex h-full w-full items-center justify-center rounded-full text-xs font-semibold uppercase select-none',
			className,
		)}
		{...props}
	/>
