...
// type DeleteUserFormProps = React.ComponentProps<typeof Card> & {
...
// 	const onSubmit = (userDeletionConfirmation: DeleteUserFormValues) => {
// 		user.deleteUserAccount(userDeletionConfirmation);
// 		console.log(userDeletionConfirmation);
// 		reset();
// 	};
